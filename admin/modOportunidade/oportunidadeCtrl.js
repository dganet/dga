app.controller("oportunidadeCtrl",function($scope, restful,$location , $timeout , $sessionStorage){
  //scope.master vazio;
  $scope.master = {};
...
//Novo registro. zera todas informaçoes do objeto
  ...
  //Lista todas oportunidades
	restful.oportunidadeList().success(function(data){
...
$scope.dados = function (id){
    ...
    $scope.reset();
		...
		restful.oportunidadeListId(id).success(function(data){
